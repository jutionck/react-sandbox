...
export default class Founder extends React.Component {
  render() {
    return (
      <section id="founder" className="p-5 bg-primary">
              ...
              <div className="card bg-light">
                <div className="card-body text-center">
                  <img
                    ...
                    alt=""
                  />
                  <h3 className="card-title mb-3">Jution CK</h3>
              ...
              <div className="card bg-light">
                <div className="card-body text-center">
                  <img
                    ...
                    alt=""
                  />
                  <h3 className="card-title mb-3">Kak Tika</h3>
                  <p className="card-text">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Assumenda accusamus nobis sed cupiditate iusto? Quibusdam.
                  </p>
              ...
              <div className="card bg-light">
                <div className="card-body text-center">
                  <img
                    ...
                    alt=""
                  />
                  <h3 className="card-title mb-3">Bang Doni</h3>
                  <p className="card-text">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Assumenda accusamus nobis sed cupiditate iusto? Quibusdam.
                  </p>
